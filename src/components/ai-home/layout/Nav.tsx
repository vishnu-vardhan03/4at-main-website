...
export default function Nav() {
  ...
  return (
    ...
    >
      {/* Ambient Glow */}
      <div
        className="pointer-events-none absolute inset-0 rounded-full bg-gradient-to-r from-violet-500/5 via-blue-500/5 to-cyan-500/5"
      />
      ...
      <a
        href="#cta-final"
        className="relative z-10 hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-[13px] font-bold bg-white text-void transition-all duration-300 hover:bg-gradient-to-r hover:from-violet-500 hover:via-fuchsia-500 hover:to-cyan-400 hover:text-white hover:shadow-[0_0_25px_rgba(139,92,246,0.4)]"
      >
        Let&apos;s talk
      </a>
    </nav>
