      ...
      <div className="section-inner">
       ...
       {/* /* Architecture reference image */}
        ...
        <div className="relative overflow-hidden" style={{ marginBottom: 16 }}>
          ...
          <div className="flex w-max gap-4 mb-4 will-change-transform" style={{ animation: "product-marquee 25s linear infinite" }}>
            {[...row1, ...row1].map((i, idx) => <IntCard key={`r1-${idx}`} i={i} />)}
          </div>
          <div className="flex w-max gap-4 will-change-transform" style={{ animation: "product-marquee 30s linear infinite reverse" }}>
