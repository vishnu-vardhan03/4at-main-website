...
export function Engagement() {
  return (
    <section id="engagement" className="relative bg-transparent site-section overflow-visible border-t border-b border-white/5">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid md:grid-cols-12 gap-8 mb-20">
          ...
          <p className="site-subheading md:col-span-4 md:col-start-9 self-end text-white/60">
